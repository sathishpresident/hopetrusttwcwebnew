...
; (function ($) {
    ...
    var eventsLoading = function () {
        ...
        },
        {
            ...
            'Members': '16 Volunteers',
            'Description': 'The Event-14 was organized on the Completion of Trust’s Second year,As on 1 st Year Completion we celebrated and planned to Enroll us in the OrganDonation Club,Man Volunteers and there parents were included there the name and became as Donors,This year due to some Internal Crisis we moved our celebration later but in the Completion day we our in the intention to do some good cause, So we brought 50 bedsheets and went to Anna square beach around 9pm we spited into 2 and one team walked on the platform side and the other team walked on the beach side, provided the bedsheets to the people, Beggars , Daily wagers and etc . who are lying there without any spirits in the winter,They the people who received this bedsheets are much happy,with there blessings we returned home,As this activity made us as a fully satisfied Event', 
        ...
        },
        {
            ...
            'place': 'Panchayat Union Primary School, Bakkiya Nagar village, Kattabettu ,Kotagiri,The Nilgiris District',
            'Time': '2 Days',
            'Members': '12 Volunteers',
            'Description': 'The Event day we left for a school located in Kotagiri, Bakkiya Nagar. Teachers reception and treats provided a measure of happiness.In the morning, there was a knowledge development and sports competitions for the students. Later in the day, students participated in performances such as dance, song and Street theater.It is commendable that these kids were trained on their own initiative and supported by the teachers. Our Puppetry Show was organized by our team to make it fun and easy for the children to raise awareness about First Aid and Children Assistance(Helpline 1098).Prizes were given to motivate students to participate in the competition! 25 thousand rupees (Rs. 25000 / -) in cash was also given to the School Management to Build Entrance gate & for Toilet Construction.We extend our sincere gratitude to the Chief of the school who gave us the full support of the event  and We thank all the School Students and Teachers who have given us full support! After the event, the group descending the mountain left for Coimbatore. The next day we reached Chennai.It is a great pleasure to work with the school for the future of the students who start at the end of the mountain and give our greatest support to the school which has a few number of teachers! We would like to express our gratitude to all members of Hope Trust and our supporters who helped and made this event possible.', 
        ...
        },
        {
            ...
            'Description': `For the past few months, we have been fighting against Corona with the fighting spirit of human beings, overcoming various hardships, stress and financial constraints,At this time we owe a debt of gratitude on behalf of HOPE TRUST to all the doctors, guards, cleaners and volunteers who fought on the field for the people, regardless of their lives!For the past few months we have been going to remote villages through our HOPE TRUST and providing them with there basic need for the Tribal village & schools to help them get education,We provide training, encouragement and life guidance to the students of the school to the best of our ability and to enhance their Skills.But due to this difficult period, we have not been able to reach out to the people directly for the last few months., However, we are making various preparations, teams and preparations for the coming period at full speed.However on this Independence Day we decided to give our Hope Trust's 21st service event by providing food for the roadside people Through this our volunteers provided 100 food parcels and water bottles in the areas around Central Chennai with due protection against the spread of corona.We saw smiles on their faces during the event.Some greeted and hugged us.These are all flexible moments.And these would not have been possible without your support. Thank you to everyone who has supported us so far !!!.`, 
